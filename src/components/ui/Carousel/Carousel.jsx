      ...
      {gallery && (
        <>
          ...
          <div className="mx-auto relative w-fit">
            <select
              className="border border-gray-300 rounded-md px-5 py-1 pr-8 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer min-w-[70px]  max-w-[300px] md:max-w-[400px] bg-sand"
